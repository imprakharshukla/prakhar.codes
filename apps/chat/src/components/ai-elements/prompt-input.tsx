    ...
    Promise.all(
      ...
      try {
        ...
        if (result instanceof Promise) {
          ...
          // Sync function completed without throwing
          if (usingProvider) {
            controller.textInput.clear();
          }
        }
  ...
  (
    {
      onChange,
      className,
      placeholder = "Beskriv din bedrift, del navn eller nettside - vi søker på nettet for deg",
      ...props
    },
    ref
  ) => {
    ...
    return (
      <InputGroupTextarea
        ref={ref}
        className={cn(
          "field-sizing-content max-h-48 min-h-16 break-words",
          className
        )}
        name="message"
